...
<?php
	...
	if(isset($_POST["firstname"])) { 
		...
		$result = mysqli_query($con,"UPDATE employee SET firstname='$firstname', lastname='$lastname', gross_salary=$salary, currency='$currency', email=$email, dob=$dob, phone='$phone', gender=$gender, photo='$path', province='$province', district='$district', location='$location', position='$position' WHERE employee_id = " . $_GET["employee_id"]);
