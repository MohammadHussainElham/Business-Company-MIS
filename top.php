...
<div class="container">
	...
	<div id="banner">
		...
		وبسایت
		<?php } ?>
		شرکت تجارتی سرزمین تکنالوژی</h1>
	...
	<div id="menu">
		<nav class="navbar navbar-default navbar-inverse" role="navigation" style="z-index:9999;position:relative;">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a data-toggle="dropdown" href="#"> محاسبات مالی <span class="caret"></span></a>
					<ul class="dropdown-menu">
				...
				<li class="dropdown"><a data-toggle="dropdown" href="#"> تنضیمات<span class="caret"></span></a>
					<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="#">فرمایشات آنلاین</a></li>
